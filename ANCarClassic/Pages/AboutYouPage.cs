...
namespace ANCarClassic.Pages
{
    public class AboutYouPage : BasePage
    {
        ...
        By lbProposerPersonalDetailsSubHeading = By.Id("ProposerPersonalDetailsSubHeading");
        ...
        private Combobox cbProposerSelectAddress = new Combobox(By.Id("ProposerSelectAddress"));
        ...
        private Button btnHomeownerYes = new Button(By.Id("HomeownerYes"));
        private Button btnHomeownerNo = new Button(By.Id("HomeownerNo"));
        ...
        public Button btnProgressBarVehicle = new Button(By.Id("ProgressBarVehicle"));
        ...
        public void ClickProgressBarVehicle(string input)
        {
            if (input.Equals("Yes"))
            {
                btnProgressBarVehicle.Click();
        ...
        public void SelectProposerSelectAddress(string input)
        {
            if (!String.IsNullOrEmpty(input))
            {
                if(_driver.FindElements(By.Id("ProposerSelectAddress")).Count > 0)
                {
                    cbProposerSelectAddress.SelectByText(input);
                }
            }
        }
        ...
        public void ClickConfirmBackContinue(string input)
        {
            if (!String.IsNullOrEmpty(input))
            {
                WaitUntilElementVisible(btnConfirmBackContinueSelector);
                btnConfirmBackContinue.Click();
                WaitForLoadingIconDisappear();
                WaitUntilElementVisible(VehiclePage.btnFindCarSelector);
            }
        }
        #endregion
        ...
        public void VerifyAboutYouPageTitle(string input)
        {
            if (input.Equals("Yes"))
            {
                WaitUntilElementVisible(btnTitle_MrSelector);
                var count = _driver.FindElements(lbProposerPersonalDetailsSubHeading).Count;
                Assert.True(count > 0);
            }
        }
        #endregion
        ...
        public void VerifyLicenceDate(string input)
        {
            if (!String.IsNullOrEmpty(input))
            {
                var i = cbLicenceDate.GetInnerText();
                var e = cbLicenceDate.GetText();
        ...
        public void SaveToDataModel(string input)
        {
            if (input.Equals("Yes"))
            {
                ...
                _aboutYouData.DrivingLicenceDate = cbLicenceDate?.GetText().Trim();
                if (_aboutYouData.DrivingLicenceDate == "Less than 1 year")
                {
                    _aboutYouData.DrivingLicenceDay = txtObtainedLicenceLessThan1YearDay.GetPopulatedValue();
                    _aboutYouData.DrivingLicenceMonth = txtObtainedLicenceLessThan1YearMonth?.GetPopulatedValue();
                    _aboutYouData.DrivingLicenceYear = txtObtainedLicenceLessThan1YearYear?.GetPopulatedValue();
                }
            }
        }
