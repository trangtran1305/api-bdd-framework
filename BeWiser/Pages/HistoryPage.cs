    ...
    public class HistoryPage : BasePage
    {
        ...
        public void SaveToDataModel(string input)
        {
            if (input.Equals("Yes"))
            {
                ...
                //if (_driverHistoryData.NCBYears != "1")
                //{
                //    _driverHistoryData.IsOtherVehicleNamedDriverYes = btnOtherVehicleNamedDriverYes.GetAttributeValue("class");
                //    _driverHistoryData.IsOtherVehicleNamedDriverNo = btnOtherVehicleNamedDriverNo.GetAttributeValue("class");
                //}
                //if (_driverHistoryData.IsOtherVehicleNamedDriverYes == "isActive")
                //{
                //    _driverHistoryData.VehicleType1 = btnOtherVehicleType1.GetAttributeValue("class");
                //    _driverHistoryData.VehicleType2 = btnOtherVehicleType2.GetAttributeValue("class");
                //}
                if (_driverHistoryData.NumberOfVehicleInHousehold != "1" && _driverHistoryData.NumberOfVehicleInHousehold != "Please Select")
                {
                    ...
                    {
                        _driverHistoryData.LargestNcbInOtherVehicle = cbLargestNcbInOtherVehicle.GetAttributeValue("class");
                    }
                }
