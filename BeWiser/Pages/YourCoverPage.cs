...
namespace BeWiser.Pages
{
    public class YourCoverPage : BasePage
    {
        ...
        // Button btnNotHadPreviousInsurance = new Button(By.Id("NotHadPreviousInsurance"));
        ...
        public void SaveToDataModel(string input)
        {
            if (input.Equals("Yes"))
            {
                ...
                //_yourCoverData.IsInsuranceNotExisted = btnNotHadPreviousInsurance?.GetAttributeValue("class");
        ...
        public void VerifyYourCoverDataDisplayedCorrectly(string input)
        {
            if (input.Equals("Yes"))
            {
                ...
                //Assert.Equal(_yourCoverData.IsInsuranceNotExisted, btnNotHadPreviousInsurance?.GetAttributeValue("class"));
