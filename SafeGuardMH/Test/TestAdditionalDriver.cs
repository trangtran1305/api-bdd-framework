...
{
    public class TestAdditionalDriver : TestDataProviderBase
    {
        static string _dataFile = Directory.GetCurrentDirectory() + "\\TestData\\SafeguardMHTestData.xlsx";
        static string _sheetName = "AdditionalDriver";

        [Theory]
        [MemberData(nameof(TestCases))]

        public void ExecuteAdditionalDriver(string testCaseId, string description, string testResult)
        {
