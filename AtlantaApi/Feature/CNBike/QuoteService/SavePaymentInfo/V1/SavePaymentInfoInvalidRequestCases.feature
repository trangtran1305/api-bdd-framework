...
Scenario Outline: Check Save Payment Info with invalid endpoint or method
	...
	| /api/V1/quote/save-payment-info    | GET    | 1          | CNBikeContext | 404        | NotFound                |
	| /api/V1/quote/save-payment-infoabc | POST   | 1          | CNBikeContext | 404        | NotFound                |
