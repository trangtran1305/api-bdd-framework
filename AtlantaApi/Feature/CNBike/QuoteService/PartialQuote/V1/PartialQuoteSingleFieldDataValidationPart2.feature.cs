...
#line hidden
        ...
        public static void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Feature/CNBike/QuoteService/PartialQuote/V1", "PartialQuoteSingleFieldDataValidationCasesPart2", null, ProgrammingLanguage.CSharp, new string[] {
                        "CNBike"});
        ...
        [Xunit.InlineDataAttribute("Risk", "Product", "Vehicle", "AdditionalDrivers", "Employment", "", "", "missing", "400", "FALSE", "At least one Employment element is required.", new string[0])]
        [Xunit.InlineDataAttribute("Risk", "Product", "Vehicle", "AdditionalDrivers", "Employment", "", "", "null", "400", "FALSE", "At least one Employment element is required.", new string[0])]
        [Xunit.InlineDataAttribute("Risk", "Product", "Vehicle", "AdditionalDrivers", "Employment", "", "", "File: ProposerEmployment602.json", "400", "FALSE", "At least one Employment element is required.", new string[0])]
        ...
        [Xunit.InlineDataAttribute("Risk", "Product", "Vehicle", "AdditionalDrivers", "DrivingLicence", "DateObtained", "", "2020-12-16T00:00:00", "200", "TRUE", "Store partial quote successfully", new string[0])]
        ...
        [Xunit.InlineDataAttribute("Risk", "Product", "Vehicle", "AdditionalDrivers", "EmailAddress", "", "", "thuongnguyenthiminh@nashtechglobal.com", "200", "TRUE", "Store partial quote successfully", new string[0])]
        ...
        [Xunit.InlineDataAttribute("Risk", "Product", "Vehicle", "VehicleDetail", "", "", "", "File: VehicleVehicleDetail787.json", "400", "FALSE", "Vehicle elements cannot be over 4.", new string[0])]
        [Xunit.InlineDataAttribute("Risk", "Product", "Vehicle", "VehicleDetail", "", "", "", "File: VehicleVehicleDetail1323.json", "400", "FALSE", "Cannot quote for both multi-bike and multi-rider.", new string[0])]
        ...
        [Xunit.InlineDataAttribute("Risk", "Product", "Vehicle", "VehicleDetail", "ClassOfUse", "", "", "\"\"", "200", "TRUE", "Store partial quote successfully", new string[0])]
        [Xunit.InlineDataAttribute("Risk", "Product", "Vehicle", "VehicleDetail", "ClassOfUse", "", "", "null", "200", "TRUE", "Store partial quote successfully", new string[0])]
        [Xunit.InlineDataAttribute("Risk", "Product", "Vehicle", "VehicleDetail", "ClassOfUse", "", "", "missing", "200", "TRUE", "Store partial quote successfully", new string[0])]
...
#line 7
 testRunner.Given("The customer has", ((string)(null)), table214, "Given ");
#line hidden
...
#line 13
 testRunner.When("The customer call quote API", ((string)(null)), table215, "When ");
#line hidden
#line 16
