...
#line hidden
        ...
        public static void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Feature/CNBike/QuoteService/Quotes/V1", "QuoteSingleFieldDataValidationCasesPart2", null, ProgrammingLanguage.CSharp, new string[] {
                        "CNBike"});
        ...
        [Xunit.InlineDataAttribute("Risk", "Product", "Vehicle", "AdditionalDrivers", "UKResidentSinceDate", "", "", "2051-12-16T00:00:00", "400", "FALSE", "UKResidentSinceDate cannot be in future.", new string[0])]
        ...
        [Xunit.InlineDataAttribute("Risk", "Product", "Vehicle", "AdditionalDrivers", "DrivingLicence", "DateObtained", "", "2051-12-16T00:00:00", "400", "FALSE", "Licence date cannot be future date.", new string[0])]
...
#line 7
 testRunner.Given("The customer has", ((string)(null)), table228, "Given ");
#line hidden
...
#line 13
 testRunner.When("The customer call quote API", ((string)(null)), table229, "When ");
#line hidden
#line 16
