...
namespace AtlantaApi.Feature.CNSelectedBike.QuoteService.Quotes.V2
{
    ...
    public partial class QuoteSingleFieldDataValidationCasesGenderMFeature : object, Xunit.IClassFixture<QuoteSingleFieldDataValidationCasesGenderMFeature.FixtureData>, System.IDisposable
    {
...
#line 1 "QuoteSingleFieldDataValidationGenderM.feature"
#line hidden
        
        public QuoteSingleFieldDataValidationCasesGenderMFeature(QuoteSingleFieldDataValidationCasesGenderMFeature.FixtureData fixtureData, AtlantaApi_XUnitAssemblyFixture assemblyFixture, Xunit.Abstractions.ITestOutputHelper testOutputHelper)
        {
        ...
        public static void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Feature/CNSelectedBike/QuoteService/Quotes/V2", "QuoteSingleFieldDataValidationCasesGenderM", null, ProgrammingLanguage.CSharp, new string[] {
                        "CNSBike"});
        ...
        [Xunit.TraitAttribute("FeatureTitle", "QuoteSingleFieldDataValidationCasesGenderM")]
        ...
        [Xunit.InlineDataAttribute("Risk", "Product", "Vehicle", "AdditionalDrivers", "Gender", "", "", "M", "400", "FALSE", "Gender must be Female if title is Miss or Mrs or Ms.", new string[0])]
...
#line 7
 testRunner.Given("The customer has", ((string)(null)), table314, "Given ");
#line hidden
...
#line 13
 testRunner.When("The customer call quote API", ((string)(null)), table315, "When ");
#line hidden
#line 16
...
#line hidden
        ...
        public class FixtureData : System.IDisposable
        {
            ...
            public FixtureData()
            {
                QuoteSingleFieldDataValidationCasesGenderMFeature.FeatureSetup();
            }
            
            void System.IDisposable.Dispose()
            {
                QuoteSingleFieldDataValidationCasesGenderMFeature.FeatureTearDown();
            }
        }
    }
}
