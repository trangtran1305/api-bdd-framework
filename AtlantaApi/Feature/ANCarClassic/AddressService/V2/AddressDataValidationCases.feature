...
Scenario Outline: Send address request with invalid params	
	...
	| missing  | 1           | PC	  | V2         | ANCarClassic | 400        | PostCode is required       |
	| GIRb 0AA | 1           |PC	  | V2         | ANCarClassic | 400        | PostCode is invalid        |
	| SE78QJ   | 1           | PC	  | V2         | ANCarClassic | 200        | Get addresses successfully |
	| se7 8qj  | 1           | PC	  | V2         | ANCarClassic | 200        | Get addresses successfully |
	| SE7 8QJ  | 1           | PC	  | V2         | ANCarClassic | 200        | Get addresses successfully |
	| bs981TL  | 1           | PC		  | V2         | ANCarClassic | 204        | NoContent                  |
	| SE7 8QJ  | missing     | PC		  | V2         | ANCarClassic | 200        | Get addresses successfully |
	| SE7 8QJ  | 2           | PC		  | V2         | ANCarClassic | 200        | Get addresses successfully |
	| SE7 8QJ  | test        | PC  	  | V2         | ANCarClassic | 200        | Get addresses successfully |