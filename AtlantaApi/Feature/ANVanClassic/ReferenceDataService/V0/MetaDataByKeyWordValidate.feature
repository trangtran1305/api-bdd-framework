...
Given User has Reference Data body
	| Property                 | Value                                       |
	| ReferenceDataRequestBody | ReferenceDataByKeyWordBodyBeWiser.json |
	| ApiVersion               | V0                                          |
	| ContextName              | BeWiser                                |
	...
	| SearchKeyWord | Cinema               | 200        | Get successfully           |
	| SearchKeyWord | Computers - Software | 200        | Get successfully           |
