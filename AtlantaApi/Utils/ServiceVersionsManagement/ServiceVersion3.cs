...
{
    public class ServiceVersion3 : ServiceVersionBase
    {
        public override ServiceEndpointName SetEndpoint()
        {
            ...
            serviceEndpointName.Quotes = "/api/v3/quote/quotes";
            ...
            // update save paymentInfo version
            serviceEndpointName.SavePaymentInfo = "/api/V2/quote/save-payment-info";
        ...
        public override ResourcePath SetResource()
        {
            ...
            resourcePath.Quotes = @"QuoteService\Quotes\V3\";
