...
{
    public class TestPaymentOptions : TestDataProviderBase
    {
        static string _dataFile = Directory.GetCurrentDirectory() + "\\TestData\\CNRenewalPortalTestData.xlsx";
        static string _sheetName = "PaymentOptions";


        //[Theory]
        [MemberData(nameof(TestCases))]

        public void ExecutePaymentOptions(string testCaseId, string description, string testResult)
        {
