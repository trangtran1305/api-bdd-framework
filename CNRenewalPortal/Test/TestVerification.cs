...
{
    public class TestVerification : TestDataProviderBase
    {
        static string _dataFile = Directory.GetCurrentDirectory() + "\\TestData\\CNRenewalPortalTestData.xlsx";      
        static string _sheetName = "VerificationQuestions";

        //[Theory]
        [MemberData(nameof(TestCases))]

        public void ExecuteVerification(string testCaseId, string description, string testResult)
        {
