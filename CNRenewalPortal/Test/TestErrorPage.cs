...
{
    public class TestErrorPage : TestDataProviderBase
    {
        static string _dataFile = Directory.GetCurrentDirectory() + "\\TestData\\CNRenewalPortalTestData.xlsx";      
        static string _sheetName = "ErrorPage";

        //[Theory]
        [MemberData(nameof(TestCases))]

        public void ExecuteErrorPage(string testCaseId, string description, string testResult)
        {
