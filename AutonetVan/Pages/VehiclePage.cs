...
namespace ANCarClassic.Pages
{
    public class VehiclePage : BasePage
    {
        ...
        private string btnBusinessUser = "//*[@formcontrolname='vehicleUsage']//button[text()=' Only you ']";
        ...
        public void InputModelOfImmobiliser(string input)
        {
            if (!String.IsNullOrEmpty(input))
            {
                cbImmobiliserType.Input(input);
            }
        }
        ...
        public void InputPurchaseDate(string input)
        {
            ...
            if (!String.IsNullOrEmpty(input))
            {
                ...
                txtPurchaseDay.Clear();
                txtPurchaseDay.Input(splittedDate.Item1);
                txtPurchaseMonth.Clear();
        ...
        public void ClickBusinessUser(string input)
        {
            if (!String.IsNullOrEmpty(input))
            {
                var btnUser = _driver.FindElement(By.XPath(btnBusinessUser.Replace("Only you", input)));
                btnUser.Click(); 
            }
        }
